...
(0, 'home', 1, 'Správa serverů, vývoj software, IoT, školení, konzultace a analýzy', 'bae34b31-ad49-4444-9bf7-805e513d30f6', 'Správa serverů, vývoj software, IoT, školení, konzultace a analýzy', 'programování, vývoj, software hardware, SEO, linux, server,admin,  konzultant, marketing', 'header.jpg', 'Bc. Josef Jebavý - správa serverů, vývoj software, IoT, školení, konzultace a analýzy', ' ', 'en'),
