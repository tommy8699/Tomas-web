...
class Container_80babcadeb extends Nette\DI\Container
{
	...
	public function createServiceContainer(): Container_80babcadeb
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_80babcadeb $container)
			{
